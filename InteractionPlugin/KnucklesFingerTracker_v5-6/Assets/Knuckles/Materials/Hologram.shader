    ...
    //cull off
      ...
      void surf (Input IN, inout SurfaceOutput o) {
         ...
         half backside = 0;
          ...
          o.Emission = _Color.a * 0.4 * lerp((_RimColor.rgb * pow (rim, _RimPower) * 20),  tex2D (_MainTex, IN.uv_MainTex).rgb*tex2D (_MainTex, IN.uv_MainTex).a * _Color  * 3 - (backside * 0.2), -(_RimColor.rgb * pow (rim, _RimPower)) + 1) * bright  * _Brightness;
         // o.Emission = center.x;
         // o.Emission = IN.dist;
